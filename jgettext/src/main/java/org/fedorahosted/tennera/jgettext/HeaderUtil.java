...
public class HeaderUtil {
	...
	public static Message generateDefaultHeader(){
		...
		headerMsg.addComment("Copyright (C) YEAR THE PACKAGE'S COPYRIGHT HOLDER"); 
		headerMsg.addComment("This file is distributed under the same license as the PACKAGE package."); 
